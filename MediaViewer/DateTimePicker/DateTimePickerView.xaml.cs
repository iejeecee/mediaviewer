...
namespace MediaViewer.DateTimePicker
{
    ...
    /// Magnus Gudmundsson: http://www.codeproject.com/KB/WPF/wpfDateTimePickerView.aspx
    /// </summary>
    /// <remarks>
    ...
    /// in all windows; you may need to wrap the DateTimePickerView, or the entire
    ...
    /// 2011-08-16 (Tue). If the user selects the day and types "19", DateTimePickerView
    ...
    public partial class DateTimePickerView : UserControl
    {
        ...
        public static readonly RoutedEvent DateChangedEvent = EventManager.RegisterRoutedEvent("DateChanged", RoutingStrategy.Bubble, typeof(RoutedEventHandler), typeof(DateTimePickerView));
        ...
        public static readonly RoutedEvent DateFormatChangedEvent = EventManager.RegisterRoutedEvent("DateFormatChanged", RoutingStrategy.Bubble, typeof(RoutedEventHandler), typeof(DateTimePickerView));

        #endregion

        #region "DependencyProperties"

        public static readonly DependencyProperty DateFormatProperty = DependencyProperty.Register("DateFormat", typeof(string), typeof(DateTimePickerView), new FrameworkPropertyMetadata("yyyy-MM-dd HH:mm", OnDateFormatChanged));

        public static DependencyProperty MaximumDateProperty = DependencyProperty.Register("MaximumDate", typeof(DateTime), typeof(DateTimePickerView), new FrameworkPropertyMetadata(Convert.ToDateTime("3000-01-01 00:00"), null, new CoerceValueCallback(CoerceMaxDate)));

        public static DependencyProperty MinimumDateProperty = DependencyProperty.Register("MinimumDate", typeof(DateTime), typeof(DateTimePickerView), new FrameworkPropertyMetadata(Convert.ToDateTime("1900-01-01 00:00"), null, new CoerceValueCallback(CoerceMinDate)));

        public static readonly DependencyProperty SelectedDateProperty = DependencyProperty.Register("SelectedDate",
        typeof(DateTime), typeof(DateTimePickerView),
        ...
        public static readonly DependencyProperty DateTextIsWrongProperty = DependencyProperty.Register("DateTextIsWrong", typeof(bool), typeof(DateTimePickerView), new FrameworkPropertyMetadata(false));
        ...
        private void DateTimePickerView_PreviewKeyDown(object sender, System.Windows.Input.KeyEventArgs e)
        {
