...
{
    [Export]
    public class GeoTagViewModel : BindableBase, IDisposable, INavigationAware, IMediaFileBrowserContentViewModel
    {

        MediaFileStackPanelViewModel mediaStackPanel;
        ...
        public GeoTagViewModel(MediaFileBrowserView mediaFileBrowserView, IEventAggregator eventAggregator)
        {
            mediaStackPanel = new MediaFileStackPanelViewModel(MediaFileWatcher.Instance.MediaFileState, eventAggregator);
            mediaStackPanel.IsVisible = true;      
            WeakEventManager<MediaStateCollectionView,MediaStateChangedEventArgs>.AddHandler(mediaStackPanel.MediaStateCollectionView,"NrItemsInStateChanged", mediaState_NrItemsInStateChanged);
            ...
            Stream htmlStream = Assembly.GetExecutingAssembly().GetManifestResourceStream("GeoTagPlugin.GeoTag.html");
            Stream scriptStream = Assembly.GetExecutingAssembly().GetManifestResourceStream("GeoTagPlugin.GeoTag.js");
