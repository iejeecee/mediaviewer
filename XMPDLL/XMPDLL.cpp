...
namespace XMPDLL {
	...
	XMPDLL_API void WINAPI composeArrayItemPath(const std::string &nameSpace, 
		const std::string &arrayName, 
		int itemIndex, 
		std::string &fullPath) 
	{
	...
	XMPDLL_API void WINAPI composeStructFieldPath(const std::string &nameSpace, 
		const std::string &structName, 
		const std::string &fieldNameSpace, 
		const std::string &fieldName, 
		std::string &fullPath)
	...
	XMPDLL_API void WINAPI encodeToBase64(const std::string &rawStr,
		std::string &encodedStr) 	
	{
		TXMPUtils<std::string>::EncodeToBase64(rawStr, &encodedStr);
	}

	XMPDLL_API void WINAPI decodeFromBase64(const std::string &encodedStr,
		std::string &rawStr) 	
	{
