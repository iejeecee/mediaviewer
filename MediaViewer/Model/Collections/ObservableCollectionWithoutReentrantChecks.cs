...
#endif
    public class ObservableCollectionWithoutReentrantChecks<T> : Collection<T>, INotifyCollectionChanged, INotifyPropertyChanged
    {
        //------------------------------------------------------
        //
        //  Constructors
        ...
        /// </summary>
        public ObservableCollectionWithoutReentrantChecks() : base() { }
        ...
        public ObservableCollectionWithoutReentrantChecks(List<T> list)
        ...
        public ObservableCollectionWithoutReentrantChecks(IEnumerable<T> collection)
        {
            if (collection == null)
